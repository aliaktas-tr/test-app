...
class OrderTrackingStepsView extends StatefulWidget {
  final Status? status;
  ...
  @override
  State<OrderTrackingStepsView> createState() => _OrderTrackingStepsViewState();
}

class _OrderTrackingStepsViewState extends State<OrderTrackingStepsView>
  ...
  Widget _listSeparated(
    ...
    return ListView.separated(
        ...
        separatorBuilder: (context, index) {
          return SizedBox(height: quarterDefaultSize);
        },
